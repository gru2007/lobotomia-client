...
if(DEFINED DEPLOY)
    set_target_properties(${PROJECT} PROPERTIES
        ...
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER "distr ios.tech.artemevsoft.amnezia"
        XCODE_ATTRIBUTE_PROVISIONING_PROFILE_SPECIFIER[variant=Debug] "dev ios.tech.artemevsoft.amnezia"
    )
else()
    set_target_properties(${PROJECT} PROPERTIES
