...
struct Log {
  private static let subsystemIdentifier = Bundle.main.bundleIdentifier ?? "tech.artemevsoft.amnezia"
  ...
  private static let appGroupID = "group.tech.artemevsoft.amnezia"
